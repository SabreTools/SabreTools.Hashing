...
| --- | --- | --- |
| \<**INTERNAL**\> | Standardized CRC implementations, RIPEMD-128, RIPEMD-160, RIPEMD-256, RIPEMD-320, xxHash-32, xxHash-64 | Built for compatability, written from original specifications where possible |
